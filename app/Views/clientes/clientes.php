                ...
                <tbody>
                    <?php foreach($datos as $dato) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <!--EDITAR-->
                                <a href="<?php echo base_url(); ?>/clientes/editar/<?php echo $dato['id']; ?>" class="btn btn-warning"><i class="fa-solid fa-square-pen"></i> Editar</a>
                                     
                                <!--BORRAR-->
                                <a href="#" data-href="<?php echo base_url(); ?>/clientes/eliminar/<?php echo $dato['id']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma"  title="Eliminar registro" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> Borrar</a>
                            </td>
                        </tr>
