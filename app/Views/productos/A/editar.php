            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <input id="precio_venta" value="<?php echo $productos['precio_venta']; ?>" class="form-control" type="text" name="precio_venta" required />
                    </div>

                    <div class="col-12 col-sm-6">
                        <label>Precio Compra:</label>
                        <input id="precio_compra" value="<?php echo $productos['precio_compra']; ?>" class="form-control" type="text" name="precio_compra" required />
                    </div>
                </div>
            </div>
