                ...
                <tbody>
                    <?php foreach($datos as $dato) { ?>
                        ...
                        <tr>
                            ...
                            <!--RESTAURAR-->
                            <td>
                                <a href="#" data-href="<?php echo base_url(); ?>/productos/reingresar/<?php echo $dato['id']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma"  title="Reingresar registro" class="btn btn-danger"><i class="fa-solid fa-trash-arrow-up"></i> Restaurar</a>
                            </td>
                        </tr>
