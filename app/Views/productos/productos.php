<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h3 class="text-success fw-semibold mt-4"><?php echo $titulo; ?></h3>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>/productos/nuevo" class="btn btn-success me-2">Agregar productos</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>/productos/eliminados" class="btn btn-info me-2"> Productos Eliminados</a>
                        </li>
