...
class Usuarios extends BaseController
{
    ...
    public function insertar()
    {
        ...
        $this->usuarios->save(['nombre' => $this->request->getPost('nombre'), 'nombre_corto' =>
    ...
    {
        $this->usuarios->update($this->request->getPost('id'), ['nombre' => $this->request->getPost('nombre'), 'nombre_corto' =>
        $this->request->getPost('nombre_corto')]);
        return redirect()->to(base_url().'/usuarios');
    }
