<div id="layoutSidenav_content" style="background: rgb(255, 255, 255)"> <!--color de fondo de la configuracion-->
    <main>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6"> 
                        <img src="<?php echo base_url(); ?>/images/perfil.jpg" width="400" height="500" class="img-responsive img-fluid rounded mx-auto d-block">
                    </div>
