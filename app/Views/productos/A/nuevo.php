            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <input id="precio_venta" value="<?php echo set_value('precio_venta') ?>" class="form-control" type="text" name="precio_venta" autofocus required />
                    </div>

                    <div class="col-12 col-sm-6">
                        <label>Precio Compra:</label>
                        <input id="precio_compra" value="<?php echo set_value('precio_compra') ?>" class="form-control" type="text" name="precio_compra" autofocus required />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <input id="stock_minimo" value="<?php echo set_value('stock_minimo') ?>" class="form-control" type="text" name="stock_minimo" autofocus required />
                    </div>
